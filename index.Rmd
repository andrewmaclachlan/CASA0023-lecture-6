...
* [Alpha](https://youtu.be/D0efHEJsfHo?t=684): use a full size regression tree (with **all** data), start with a value of 0 then increase **until pruning** (removing a leaf) gives lower **tree score** .
